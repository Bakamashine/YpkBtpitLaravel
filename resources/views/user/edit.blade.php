    ...
    <section class="catalog  profile">
        ...
        <form method="post" action="{{route('user_edit.update')}}" class="m-3" enctype="multipart/form-data">
            ...
            <div class="d-flex align-items-center justify-content-between">
                <label for="avatar"><img id="avatarPreview" src="{{get_image_or_default($user->avatar)}}"
                                         class=" avatar" alt="..."></label>
                ...
                <div class="mx-3" style="flex: 1;">
                    ...
                    @enderror
                    <hr style="width: 100%; margin: 0;">
                    <p><b>Номер телефона: </b><input type="tel" name="phone_number"
                    ...
                    @enderror
                    <hr style="width: 100%; margin: 0;">
                    <p><b>Доп информация: </b><input type="text" name="user_info"

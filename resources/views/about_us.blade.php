...
@section('content')
    ...
    <section class="myGrey py-4 py-md-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h1 class="display-5 fw-bold" style="color: #001b44;">О техникуме <span class="myA">БТПИТ</span>
                    </h1>
                    <p class="lead mt-3">Государственное бюджетное профессиональное образовательное учреждение
                        Воронежской области «Борисоглебский техникум промышленных и информационных технологий» —
                        современное образовательное пространство, где готовят востребованных специалистов.</p>
                    <div class="d-flex flex-wrap gap-3 mt-4">
                        <a href="#specialties" class="btn btn-outline-secondary rounded-pill px-4 py-2"><i
                                class="fas fa-graduation-cap me-2"></i>Специальности</a>
                        <a href="#advantages" class="btn btn-outline-secondary rounded-pill px-4 py-2"><i
                                class="fas fa-star me-2"></i>Преимущества</a>
                    </div>
                </div>
                    ...
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div><strong>Адрес:</strong><br>397160, Воронежская обл., г. Борисоглебск, ул.
                                    Третьяковская, д. 14
                                </div>
                            </div>
                            <hr>
                            <div><i class="fas fa-calendar-alt me-2 myA"></i> <strong>Год основания:</strong> 2015
                                (слияние трёх колледжей)
                            </div>
                            <div class="mt-2"><i class="fas fa-check-circle me-2 myA"></i>
                                <strong>Аккредитация:</strong> государственная, статус СПО
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="bg-white p-4 rounded-4 shadow-sm h-100">
                    ...
                    <ul class="list-unstyled mt-3">
                        <li class="mb-2"><i class="fas fa-users me-2 myA"></i> <strong>Контингент:</strong> более 1000
                            студентов
                        </li>
                        <li class="mb-2"><i class="fas fa-building me-2 myA"></i> <strong>Площадь помещений:</strong>
                            ~14 000 м²
                        </li>
                        <li class="mb-2"><i class="fas fa-laptop-code me-2 myA"></i> <strong>Электронная среда:</strong>
                            онлайн-курсы, методические пособия
                        </li>
                        <li class="mb-2"><i class="fas fa-chalkboard-user me-2 myA"></i>
                            <strong>Профессионалитет:</strong> федеральный проект ускоренной подготовки
                        </li>
                    </ul>
                    <!-- ФОТО 2: Учебный процесс -->
                    <div class="photo-card mt-3">
                        <img src="{{asset('img/img113.jpg')}}" alt="Учебный процесс в БТПИТ"
            ...
            <div class="col-md-6">
                <div class="bg-white p-4 rounded-4 shadow-sm h-100">
                    ...
                    <ul class="list-unstyled mt-3">
                        ...
                        <li class="mt-2"><i class="fas fa-globe me-2"></i> <a href="https://btpit.obrvrn.ru/"
                                                                              class="myA" target="_blank">btpit.obrvrn.ru</a>
                        </li>
                    </ul>
                    <div class="alert alert-info mt-3 mb-0 py-2 small">
                        <i class="fas fa-info-circle"></i> Приём документов: на базе 9 класса, без экзаменов (конкурс
                        аттестатов).
                    </div>
                    <!-- ФОТО 3: Приёмная комиссия -->
                    <div class="photo-card mt-3">
                        <img src="{{asset('img/img115.jpg')}}" alt="Приёмная комиссия БТПИТ"
                             onerror="this.style.display='none'">
                        <div class="p-2 bg-light">
    ...
    <section id="specialties" class="container py-4">
        ...
        <div class="table-responsive shadow-sm rounded-4 overflow-hidden">
            <table class="table table-bordered table-hover mb-0 align-middle table-specials">
                ...
                <tr>
                    <td>44.02.05</td>
                    <td>Коррекционная педагогика в начальном образовании</td>
                    <td>3 года 10 мес.</td>
                </tr>
                <tr>
                    <td>38.02.01</td>
                ...
                <tr>
                    <td>43.02.16</td>
                    <td>Туризм и гостеприимство</td>
                    <td>2 года 10 мес.</td>
                </tr>
                <tr class="table-secondary fw-semibold">
                    <td>15.01.05</td>
                    <td>Сварщик (ручная и частично механизированной сварки) — рабочая профессия</td>
                    <td>1 год 10 мес.</td>
                </tr>
                </tbody>
            </table>
        </div>
        <div class="mt-3 text-muted small text-center">* Возможно обучение по программам подготовки квалифицированных
            рабочих, уточняйте в приёмной комиссии.
        </div>
    </section>
    ...
    <section id="advantages" class="myGrey py-5">
        <div class="container">
            ...
            <div class="photo-card mt-5">
                <img src="{{asset('img/img116.jpg')}}" alt="Студенческие мероприятия в БТПИТ" class="photo-horizontal"
                     onerror="this.style.display='none'">
        ...
        <div class="row g-5">
            <div class="col-md-6">
                <div class="bg-white p-4 rounded-4 shadow-sm h-100">
                    ...
                    <ul class="list-group list-group-flush bg-transparent">
                        <li class="list-group-item bg-transparent"><i class="fas fa-check-circle text-success me-2"></i>
                            Выпускникам 9 классов, желающим получить профессию раньше сверстников.
                        </li>
                        <li class="list-group-item bg-transparent"><i class="fas fa-check-circle text-success me-2"></i>
                            Тем, кто хочет работать в IT, машиностроении, педагогике, экономике, юриспруденции или
                            туризме.
                        </li>
                        <li class="list-group-item bg-transparent"><i class="fas fa-check-circle text-success me-2"></i>
                            Абитуриентам, ценящим практику и реальные рабочие задачи.
                        </li>
                        <li class="list-group-item bg-transparent"><i class="fas fa-check-circle text-success me-2"></i>
                            Тем, кто хочет получить отсрочку от армии и бюджетное образование.
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-md-6">
                <div class="bg-white p-4 rounded-4 shadow-sm h-100">
                    ...
                    <p><strong>Формат приёма:</strong> на общедоступной основе, <span
                            class="badge myLightBlue text-white">конкурс аттестатов</span> (без вступительных
                        экзаменов).</p>
                    <p><strong>Способы подачи документов:</strong> лично в приёмную комиссию, по почте, через портал
                        Госуслуг.</p>
                    <p><strong>Сроки приёма:</strong> обычно с июня, актуальную информацию уточняйте на сайте.</p>
                    <a href="https://btpit.obrvrn.ru/" target="_blank"
                       class="btn myLightBlue text-white rounded-pill px-4 mt-2"><i
                            class="fas fa-external-link-alt me-2"></i>Перейти на официальный сайт</a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-8">
                    <div class="card border-0 shadow-lg rounded-4 bg-white">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <p class="fs-5 fst-italic mt-3">«Учусь в БТПИТ на 3 курсе на сварщика. Условия в техникуме
                                хорошие. За время обучения было много практики. Это поможет мне в будущем.»</p>
                            <p class="fs-5 fst-italic border-top pt-3 mt-3">«Все преподаватели справедливые и готовы
                                помочь в трудную минуту. После поступления я стала хорошо учиться, и у меня появилось
                                еще больше друзей.»</p>
                            ...
                            <div class="photo-card mt-4">
                                <img src="{{ asset('img/img119.jpg') }}" alt="Студенты БТПИТ" class="adaptive-photo"
                                     onerror="this.style.display='none'">
    ...
    <section class="container py-5">
        ...
        <div class="text-center small text-muted mt-4">
            Рекомендация: Для самой актуальной информации о приёме на 2026/2027 учебный год обращайтесь в приёмную
            комиссию или на официальный сайт <a href="https://btpit.obrvrn.ru/"
                                                class="myA fw-semibold">btpit.obrvrn.ru</a>
        </div>
    </section>
@endsection

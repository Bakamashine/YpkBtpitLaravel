                        ...
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-start mb-4">
                                <div>
                                    ...
                                    <span class="badge bg-secondary fs-6">{{ $order->product->is_product ? 'Товар' : 'Услуга' }}</span>
                                </div>
                            ...
                            <div class="row g-4 mb-4">
                                ...
                                <div class="col-md-6 d-flex flex-column justify-content-center">
                                    <h5 class="text-primary fw-bold">{{ number_format($order->product->product_cost, 0, ',', ' ') }} руб.</h5>
                                    <p class="mb-1"><strong>Дата заказа:</strong> {{ $order->date?->format('d.m.Y') ?? '—' }}</p>
                                    <p class="mb-1"><strong>Заказчик:</strong> {{ $order->customer->name ?? '—' }}</p>
                                    <p class="mb-0"><strong>Исполнитель:</strong> {{ $order->executor->name ?? '—' }}</p>
                                </div>
                            </div>

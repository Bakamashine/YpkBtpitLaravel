...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Contracts\IImageService' => \App\Services\ImageService::class,
            'App\Contracts\Repository\IOrderRepository' => \App\Repository\OrderRepository::class,
            'App\Contracts\Repository\IProductRepository' => \App\Repository\ProductRepository::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\ivan\PhpstormProjects\YpkBtpitLaravel\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\ivan\\PhpstormProjects\\YpkBtpitLaravel\\public\\storage',
...
'fortify.passkeys.timeout','fortify.features','image.driver','image.options.autoOrientation','image.options.decodeAnimation',
'image.options.backgroundColor','image.options.strip','l5-swagger.default','l5-swagger.documentations.default.api.title','l5-swagger.documentations.default.routes.api',
...
'sanctum.rt_expiration','services.postmark.key','services.resend.key','services.ses.key','services.ses.secret',
...
'sitemap.guzzle_options','sitemap.execute_javascript','sitemap.chrome_binary_path','sitemap.crawl_profile','telescope.enabled',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.ignore_status_codes','telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','passkeys.relying_party_id','passkeys.allowed_origins',
...
'signed','throttle','verified','admin','manager',
'banned',);
...
'passkey.confirm','passkey.registration-options','passkey.store','passkey.destroy','sanctum.csrf-cookie','telescope','main','home','user.detail',
'user_edit','user_edit.update','feedback.index','feedback.create','feedback.store',
'feedback.destroy','order.create','order.store','order.show','favourite.index',
'favourite.store','favourite.destroy','ypk.store','ypk.destroy','order_management.index',
'order_management.close','order_management.update-status','product.index','product.create','product.store',
'product.edit_page','product.edit','product.update','product.destroy','user_management.index',
'user_management.create','user_management.store','user_management.edit','user_management.update','user_management.destroy',
'user_management.toggle-active','product.show','about_us','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'about_us','auth.login','auth.register','components.alert','components.feedback-card',
'components.order-card','components.product-card','feedback.create','feedback.index','index',
'l5-swagger::index','layouts.basic','orders.create','orders.management','orders.show',
...
'pagination::simple-bootstrap-4','pagination::simple-bootstrap-5','pagination::simple-tailwind','pagination::tailwind','products.create',
'products.edit','products.edit_page','products.show','user.edit','user.favorite',
'user.home','user.show','users.create','users.edit','users.index',
'vendor.l5-swagger.index','vendor.pagination.bootstrap-3','vendor.pagination.bootstrap-4','vendor.pagination.bootstrap-5','vendor.pagination.semantic-ui',
...
'breadcrumbs::tailwind','breadcrumbs::uikit','l5-swagger::index','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'pagination::bootstrap-3','pagination::bootstrap-4','pagination::bootstrap-5','pagination::semantic-ui','pagination::simple-bootstrap-3',
'pagination::simple-bootstrap-4','pagination::simple-bootstrap-5','pagination::simple-tailwind','pagination::tailwind','sitemap::image',
...
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name','auth.failed','auth.password','auth.throttle','pagination.previous',
...
'validation.uuid','validation.custom.attribute-name.rule-name','validation.attributes.address','validation.attributes.avatar','validation.attributes.comment',
'validation.attributes.current_password','validation.attributes.customer_id','validation.attributes.customers_comment','validation.attributes.date','validation.attributes.description',
'validation.attributes.email','validation.attributes.executor_id','validation.attributes.fullName','validation.attributes.id','validation.attributes.image_path',
'validation.attributes.is_active','validation.attributes.is_product','validation.attributes.name','validation.attributes.password','validation.attributes.password_confirmation',
'validation.attributes.phone_number','validation.attributes.phoneNumber','validation.attributes.photo_path','validation.attributes.product_cost','validation.attributes.product_id',
'validation.attributes.product_info','validation.attributes.product_name','validation.attributes.productId','validation.attributes.raiting','validation.attributes.rating',
'validation.attributes.refreshToken','validation.attributes.role_id','validation.attributes.role_name','validation.attributes.status_name','validation.attributes.status_order_id',
'validation.attributes.status_product_id','validation.attributes.statusOrderId','validation.attributes.user_comment','validation.attributes.user_id','validation.attributes.user_info',
'validation.attributes.userComment','validation.attributes.ypk_id','validation.attributes.ypk_name','validation.attributes.ypkName',);
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','ACCESS_TOKEN_EXPIRATION_TIME',);

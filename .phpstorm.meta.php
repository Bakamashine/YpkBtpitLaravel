...
'image.options.backgroundColor','image.options.strip','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','passkeys.relying_party_id','passkeys.allowed_origins','passkeys.user_handle_secret',
'passkeys.timeout','passkeys.guard','passkeys.middleware','passkeys.management_middleware','passkeys.throttle',
'passkeys.redirect','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'two-factor.secret-key','two-factor.recovery-codes','two-factor.regenerate-recovery-codes','passkey.login-options','passkey.login',
'passkey.confirm-options','passkey.confirm','passkey.registration-options','passkey.store','passkey.destroy',
'sanctum.csrf-cookie','telescope','main','home','user_edit',
'user_edit.update','favourite.index','favourite.store','favourite.destroy','ypk.store',
'ypk.destroy','product.index','product.create','product.store','product.edit_page',
'product.edit','product.update','product.destroy','user_management.index','user_management.create',
'user_management.store','user_management.edit','user_management.update','user_management.destroy','product.show',
'about_us','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'about_us','auth.login','auth.register','components.product-card','index',
'layouts.basic','pagination::bootstrap-3','pagination::bootstrap-4','pagination::bootstrap-5','pagination::semantic-ui',
...
'products.create','products.edit','products.edit_page','products.show','user.edit',
'user.favorite','user.home','users.create','users.edit','users.index',
...
'vendor.pagination.simple-bootstrap-4','vendor.pagination.simple-bootstrap-5','vendor.pagination.simple-tailwind','vendor.pagination.tailwind','breadcrumbs::bootstrap4',
...
'C:.Users.ivan.PhpstormProjects.YpkBtpitLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
